...
export const ReportResult = (props: {onNavigate: (string: RootScreens) => void; }) => {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.user}>
          ...
          >
            eBus đã ghi nhận và xin cảm ơn những đóng góp ý kiến của bạn để góp phần cải thiện dịch vụ của chúng tôi
          </Text>
          <TouchableOpacity 
