...
export const Account = (props: {onNavigate: (string: RootScreens) => void; }) => {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.grid}>
            <View style={{marginTop: '5%', marginBottom: '15%', flexDirection: 'column', justifyContent: 'space-between', alignItems: 'center', width: '100%'}}>
                <TouchableOpacity 
                    onPress={() => props.onNavigate(RootScreens.ACCOUNT_DETAIL)}
                    style = {{borderWidth: 0, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: 'white', width: '80%', borderRadius: 5, paddingTop: 15, paddingBottom: 15}}
                >
                    <Text style = {{color: 'black', fontSize: 15, fontWeight: 'bold'}}>Thông tin tài khoản</Text>
                </TouchableOpacity>
            ...
            <View style={{flexDirection: 'column', justifyContent: 'space-between', alignItems: 'center', width: '100%'}}>
                ...
                <TouchableOpacity 
                    ...
                    style = {{marginBottom: '3%', borderWidth: 0, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: 'white', width: '80%', borderRadius: 5, paddingTop: 15, paddingBottom: 15}}
                >
                    <Text style = {{color: 'black', fontSize: 15, fontWeight: 'bold'}}>Góp ý</Text>
                </TouchableOpacity>
            </View>
      </View>
    </View>
